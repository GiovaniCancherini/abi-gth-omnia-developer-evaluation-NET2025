...
/// </summary>
public class GetBySaleIdHandler : IRequestHandler<GetBySaleIdCommand, GetBySaleIdResult>
{
    ...
    public async Task<GetBySaleIdResult> Handle(GetBySaleIdCommand request, CancellationToken cancellationToken)
    {
